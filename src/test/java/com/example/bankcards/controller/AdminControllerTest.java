...
// * изменил: удалены WebApplicationContext, MockMvcBuilders; добавлены @MockBean для JwtUtil, UserDetailsServiceImpl, UserRepository; добавлен CSRF для POST/PUT/DELETE; использован thenAnswer для UserDetails.getAuthorities; добавлены тесты для JwtAuthenticationException, JwtExpiredException; совместимость с Spring Boot 3.3.5 (Mockito 5.11.0).
// */
//@WebMvcTest(AdminController.class)
