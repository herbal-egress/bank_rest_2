...
-- Реальные номера карт (без шифрования), зашифрованные CVV
INSERT INTO bankrest.cards (id, number, name, expiration, status, balance, cvv, user_id)
VALUES
-- Карты администратора (2 карты)
(1, '4111111111111111', 'Admin Main Card', '12-27', 'ACTIVE', 10000.00, '123', 1),
(2, '4222222222222222', 'Admin Backup Card', '11-26', 'ACTIVE', 5000.00, '456', 1),

-- Карты пользователя (2 карты)
(3, '4333333333333333', 'User Debit Card', '10-25', 'ACTIVE', 1500.00, '789', 2),
(4, '4444444444444444', 'User Credit Card', '09-28', 'BLOCKED', 2000.00, '321', 2);
