-- =====================================================================
-- 002_init_data.sql
-- Скрипт инициализации тестовых данных для схемы bankrest
...
-- 1. Роли
-- =====================================================================
INSERT INTO bankrest.roles (id, name) VALUES
                                          (1, 'ADMIN'),
                                          (2, 'USER');
...
-- 3. Связь user_roles
-- =====================================================================
INSERT INTO bankrest.user_roles (user_id, role_id) VALUES
                                                       (1, 1), -- admin -> ADMIN
                                                       (2, 2), -- user -> USER
                                                       (3, 2), -- test1 -> USER
                                                       (4, 2); -- test2 -> USER
...
-- =====================================================================
INSERT INTO bankrest.cards (id, number, name, expiration, status, balance, cvv, user_id) VALUES
                                                                                             (1, 'ENCRYPTED_4111111111111111', 'Admin Card', '12-27', 'ACTIVE', 10000.00, '123', 1),
...
-- =====================================================================
-- Дополнение: 20+ дополнительных карт для существующих пользователей
-- (user, test1, test2) для тестирования пагинации и поиска
-- =====================================================================

-- Карты для пользователя 2 (user) - 8 дополнительных карт
INSERT INTO bankrest.cards (id, number, name, expiration, status, balance, cvv, user_id) VALUES
                                                                                             (26, 'ENCRYPTED_4666666666666626', 'User Premium Gold', '12-27', 'ACTIVE', 12000.00, '126', 2),
...
INSERT INTO bankrest.cards (id, number, name, expiration, status, balance, cvv, user_id) VALUES
                                                                                             (34, 'ENCRYPTED_4777777777777734', 'Test1 Platinum', '12-27', 'ACTIVE', 18000.00, '134', 3),
...
INSERT INTO bankrest.cards (id, number, name, expiration, status, balance, cvv, user_id) VALUES
                                                                                             (41, '4888888888888841', 'Test2 Gold Premium', '12-27', 'ACTIVE', 16000.00, '141', 4),
