...
public class CardDataConverter implements AttributeConverter<String, String> {
    ...
    private String ensureKeyLength(String key) {
        ...
        // Для AES нужен ключ длиной 16, 24 или 32 байта
        ...
        // Если ключ длиннее 32 байт, обрезаем до 32
    ...
    public String convertToEntityAttribute(String dbData) {
        ...
        // Если данные начинаются с ENCRYPTED_CVV_, это старые тестовые данные - возвращаем как есть
