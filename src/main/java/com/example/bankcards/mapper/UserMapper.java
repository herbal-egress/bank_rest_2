...
public interface UserMapper {
    ...
    @Mapping(target = "roles", ignore = true) // роли устанавливаются в сервисе на основе поля role
    @Mapping(target = "password", ignore = true) // пароль обрабатывается в сервисе
